...
public:
  ...
  Semaphore&
  operator=(const Semaphore& rhs) = delete;
  Semaphore&
  operator=(Semaphore&& rhs) = delete;
...
public:
  ...
  CriticalSection&
  operator=(const CriticalSection& rhs) = delete;
  CriticalSection&
  operator=(CriticalSection&& rhs) = delete;
...
public:
   ...
   */
  [[nodiscard]] constexpr const Environment&
  environment() const
  {
    return *env_;
  }
   ...
   */
  [[nodiscard]] constexpr Clock::time_point
  runningSince() const
  {
   ...
   */
  [[nodiscard]] bool
  isOverSimulationCountLimit() const noexcept;
  ...
  Model&
  operator=(Model&& rhs) noexcept = delete;
  Model&
   ...
   */
  void
  readWeather(string filename, const FwiWeather& yesterday, double latitude);
  /**
   ...
   */
  void
  makeStarts(Coordinates coordinates, const Point& point, const string_view perim, size_t size);
  /**
