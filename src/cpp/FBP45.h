...
static util::LookupTable<&calculate_surface_fuel_consumption_d1> SURFACE_FUEL_CONSUMPTION_D1{};
/**
...
public:
  ...
  FuelNonMixed&
  operator=(const FuelNonMixed& rhs) noexcept = delete;
  FuelNonMixed&
  operator=(FuelNonMixed&& rhs) noexcept = delete;
protected:
  ...
  ) const noexcept override
  {
    return this->limitIsf(
      1.0,
      calculateRos(spread.nd(), *spread.weather(), isi) * spread.slopeFactor()
    );
  }
  virtual /**
...
public:
  ...
  FuelConifer&
  operator=(const FuelConifer& rhs) noexcept = delete;
  FuelConifer&
  operator=(FuelConifer&& rhs) noexcept = delete;
protected:
  /**
...
public:
  ...
  FuelJackpine&
  operator=(const FuelJackpine& rhs) noexcept = delete;
  FuelJackpine&
  operator=(FuelJackpine&& rhs) noexcept = delete;
 ...
 * \return Surface fuel consumption (SFC) (kg/m^2) [ST-X-3 eq 12]
 */
static util::LookupTable<&calculate_surface_fuel_consumption_pine> SURFACE_FUEL_CONSUMPTION_PINE{};
/**
...
public:
  ...
  FuelPine&
  operator=(const FuelPine& rhs) noexcept = delete;
  FuelPine&
  operator=(FuelPine&& rhs) noexcept = delete;
  using FuelConifer<A, B, C, Bui0, Cbh, Cfl, BulkDensity, 15, DuffDepth>::FuelConifer;
  /**
   * \brief Surface fuel consumption (SFC) (kg/m^2) [ST-X-3 eq 12]
   * \param spread SpreadInfo to use
...
public:
  ...
  FuelD1&
  operator=(const FuelD1& rhs) noexcept = delete;
  FuelD1&
  operator=(FuelD1&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type D-1
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelD1(
    const FuelCodeSize& code
  ) noexcept
    : FuelNonMixed(code, "D-1", false, data::LOG_0_90, &Duff::Peat)
  {
  }
  /**
   ...
   */
  [[nodiscard]] MathSize
  isfD1(const SpreadInfo& spread, MathSize ros_multiplier, MathSize isi) const noexcept;
};
}
/**
...
public:
  ...
  FuelMixed&
  operator=(const FuelMixed& rhs) noexcept = delete;
  FuelMixed&
  operator=(FuelMixed&& rhs) noexcept = delete;
  /**
...
public:
  ...
  FuelMixedDead&
  operator=(const FuelMixedDead& rhs) noexcept = delete;
  FuelMixedDead&
  operator=(FuelMixedDead&& rhs) noexcept = delete;
  /**
...
public:
  ...
  FuelMixedWood&
  operator=(const FuelMixedWood& rhs) noexcept = delete;
  FuelMixedWood&
  operator=(FuelMixedWood&& rhs) noexcept = delete;
  /**
...
public:
  ...
  FuelGrass&
  operator=(const FuelGrass& rhs) noexcept = delete;
  FuelGrass&
  operator=(FuelGrass&& rhs) noexcept = delete;
  /**
   * \brief A grass fuel type
   * \param code Code to identify fuel with
   * \param name Name of the fuel
  ...
  {
    const MathSize curing = wx.dc().asValue() > 500 ?   // we're in drought conditions
                              100
...
public:
  ...
  FuelC1&
  operator=(const FuelC1& rhs) noexcept = delete;
  FuelC1&
  operator=(FuelC1&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-1
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC1(
    const FuelCodeSize& code
  ) noexcept
    : FuelConifer(code, "C-1", data::LOG_0_90, &Duff::Reindeer, &Duff::Peat)
  {
  }
  /**
   ...
   */
  [[nodiscard]] MathSize
  surfaceFuelConsumption(const SpreadInfo& spread) const noexcept override;
};
/**
...
public:
  ...
  FuelC2&
  operator=(const FuelC2& rhs) noexcept = delete;
  FuelC2&
  operator=(FuelC2&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-2
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC2(
    const FuelCodeSize& code
  ) noexcept
    : FuelConifer(code, "C-2", data::LOG_0_70, &Duff::SphagnumUpper)
  {
  }
  /**
   * \brief Surface Fuel Consumption (SFC) (kg/m^2) [ST-X-3 eq 10]
...
public:
  ...
  FuelC3&
  operator=(const FuelC3& rhs) noexcept = delete;
  FuelC3&
  operator=(FuelC3&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-3
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC3(
    const FuelCodeSize& code
  ) noexcept
    : FuelJackpine(code, "C-3", data::LOG_0_75, &Duff::FeatherMoss, &Duff::PineSeney)
  {
  }
};
/**
...
public:
  ...
  FuelC4&
  operator=(const FuelC4& rhs) noexcept = delete;
  FuelC4&
  operator=(FuelC4&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-4
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC4(
    const FuelCodeSize& code
  ) noexcept
    : FuelJackpine(code, "C-4", data::LOG_0_80, &Duff::PineSeney)
  {
  }
};
/**
...
public:
  ...
  FuelC5&
  operator=(const FuelC5& rhs) noexcept = delete;
  FuelC5&
  operator=(FuelC5&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-5
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC5(
    const FuelCodeSize& code
  ) noexcept
    : FuelPine(code, "C-5", data::LOG_0_80, &Duff::PineSeney)
  {
  }
};
/**
...
public:
  ...
  FuelC6&
  operator=(const FuelC6& rhs) noexcept = delete;
  FuelC6&
  operator=(FuelC6&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-6
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC6(
    const FuelCodeSize& code
  ) noexcept
    : FuelPine(code, "C-6", data::LOG_0_80, &Duff::PineSeney)
  {
  }
protected:
  /**
   ...
   */
  [[nodiscard]] MathSize
  finalRos(const SpreadInfo& spread, MathSize isi, MathSize cfb, MathSize rss)
    const noexcept override;
};
/**
...
public:
  ...
  FuelC7&
  operator=(const FuelC7& rhs) noexcept = delete;
  FuelC7&
  operator=(FuelC7&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type C-7
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelC7(
    const FuelCodeSize& code
  ) noexcept
    : FuelConifer(code, "C-7", data::LOG_0_85, &Duff::SprucePine)
  {
  }
  /**
...
public:
  ...
  FuelD2&
  operator=(const FuelD2& rhs) noexcept = delete;
  FuelD2&
  operator=(FuelD2&& rhs) noexcept = delete;
  // HACK: assume same bulk_density and inorganicContent as D1
  /**
   * \brief FBP fuel type D-2
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelD2(
    const FuelCodeSize& code
  ) noexcept
    : FuelNonMixed(code, "D-2", false, data::LOG_0_90, &Duff::Peat)
  {
  }
  /**
   ...
   */
  [[nodiscard]] MathSize
  calculateRos(int nd, const wx::FwiWeather& wx, MathSize isi) const noexcept override;
};
/**
...
public:
  ...
  FuelM1&
  operator=(const FuelM1& rhs) noexcept = delete;
  FuelM1&
  operator=(FuelM1&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type M-1
   * \param code Code to identify fuel with
   * \param name Name of the fuel
...
public:
  ...
  FuelM2&
  operator=(const FuelM2& rhs) noexcept = delete;
  FuelM2&
  operator=(FuelM2&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type M-2
   * \param code Code to identify fuel with
   * \param name Name of the fuel
...
public:
  ...
  FuelM3&
  operator=(const FuelM3& rhs) noexcept = delete;
  FuelM3&
  operator=(FuelM3&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type M-3
   * \param code Code to identify fuel with
   * \param name Name of the fuel
  ...
  constexpr FuelM3(
    ...
    : FuelMixedDead<120, 572, 140, 50, 10, PercentDeadFir>(code, name, data::LOG_0_80)
  {
  }
};
/**
...
public:
  ...
  FuelM4&
  operator=(const FuelM4& rhs) noexcept = delete;
  FuelM4&
  operator=(FuelM4&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type M-4
   * \param code Code to identify fuel with
   * \param name Name of the fuel
  ...
  constexpr FuelM4(
    ...
    : FuelMixedDead<100, 404, 148, 50, 2, PercentDeadFir>(code, name, data::LOG_0_80)
  {
  }
};
/**
...
public:
  ...
  FuelO1A&
  operator=(const FuelO1A& rhs) noexcept = delete;
  FuelO1A&
  operator=(FuelO1A&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type O-1a.
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelO1A(
    const FuelCodeSize& code
  ) noexcept
...
public:
  ...
  FuelO1B&
  operator=(const FuelO1B& rhs) noexcept = delete;
  FuelO1B&
  operator=(FuelO1B&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type O-1b.
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelO1B(
    const FuelCodeSize& code
  ) noexcept
...
public:
  ...
  FuelSlash&
  operator=(const FuelSlash& rhs) noexcept = delete;
  FuelSlash&
  operator=(FuelSlash&& rhs) noexcept = delete;
  /**
   * \brief A slash fuel type
   * \param code Code to identify fuel with
   * \param name Name of the fuel
...
public:
  ...
  FuelS1&
  operator=(const FuelS1& rhs) noexcept = delete;
  FuelS1&
  operator=(FuelS1&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type S-1
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelS1(
    const FuelCodeSize& code
  ) noexcept
    : FuelSlash(code, "S-1", data::LOG_0_75, &Duff::FeatherMoss, &Duff::PineSeney)
  {
  }
};
/**
...
public:
  ...
  FuelS2&
  operator=(const FuelS2& rhs) noexcept = delete;
  FuelS2&
  operator=(FuelS2&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type S-2
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelS2(
    const FuelCodeSize& code
  ) noexcept
    : FuelSlash(code, "S-2", data::LOG_0_75, &Duff::FeatherMoss, &Duff::WhiteSpruce)
  {
  }
};
/**
...
public:
  ...
  FuelS3&
  operator=(const FuelS3& rhs) noexcept = delete;
  FuelS3&
  operator=(FuelS3&& rhs) noexcept = delete;
  /**
   * \brief FBP fuel type S-3
   * \param code Code to identify fuel with
   */
  explicit constexpr FuelS3(
    const FuelCodeSize& code
  ) noexcept
    : FuelSlash(code, "S-3", data::LOG_0_75, &Duff::FeatherMoss, &Duff::PineSeney)
  {
  }
};
}
...
public:
  ...
  FuelVariable&
  operator=(FuelVariable&& rhs) noexcept = delete;
  FuelVariable&
  operator=(const FuelVariable& rhs) = delete;
  /**
...
public:
  ...
  FuelD1D2&
  operator=(const FuelD1D2& rhs) noexcept = delete;
  FuelD1D2&
  operator=(FuelD1D2&& rhs) noexcept = delete;
  /**
...
public:
  ...
  FuelM1M2&
  operator=(const FuelM1M2& rhs) noexcept = delete;
  FuelM1M2&
  operator=(FuelM1M2&& rhs) noexcept = delete;
...
public:
  ...
  FuelM3M4&
  operator=(const FuelM3M4& rhs) noexcept = delete;
  FuelM3M4&
  operator=(FuelM3M4&& rhs) noexcept = delete;
  /**
...
public:
  ...
  FuelO1&
  operator=(const FuelO1& rhs) noexcept = delete;
  FuelO1&
  operator=(FuelO1&& rhs) noexcept = delete;
  /**
