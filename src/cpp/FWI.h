...
public:
   ...
   */
  FwiWeather&
  operator=(FwiWeather&& rhs) noexcept = default;
  /**
   ...
   */
  FwiWeather&
  operator=(const FwiWeather& rhs) = default;
  /**
...
ostream&
operator<<(ostream& os, const FwiWeather& w);
