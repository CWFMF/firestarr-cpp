...
public:
   ...
   */
  Iteration&
  operator=(const Iteration& rhs) = default;
  /**
   ...
   */
  Iteration*
  reset_with_new_start(const shared_ptr<topo::Cell>& start_cell);
#endif
  /**
   ...
   */
  Iteration*
  reset(mt19937* mt_extinction, mt19937* mt_spread);
  /**
