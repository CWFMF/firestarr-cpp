...
cleanup();
void
delExcList(excList* l);
void
delFrame(Frame* f);
void
delNode(Node* n);
void
insert(point p, excList* l);
excList*
newExcList();
Frame*
newFrame(Frame* next);
Node*
newNode(point p, Node* fwd);
void
popFrame(excList* l);
void
pushAfterNode(Node* n, excList* l);
void
removeAfterNode(Node* del, excList* l);
void
showList(excList* l);
void
showListFull(excList* l);
