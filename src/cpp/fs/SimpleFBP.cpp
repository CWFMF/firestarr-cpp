...
int test_fbp(const int argc, const char* const argv[])
{
  ...
  compare_fuel("C1", simplefbp::C1, *dynamic_cast<const FuelOldC1*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C2", simplefbp::C2, *dynamic_cast<const FuelOldC2*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C3", simplefbp::C3, *dynamic_cast<const FuelOldC3*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C4", simplefbp::C4, *dynamic_cast<const FuelOldC4*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C5", simplefbp::C5, *dynamic_cast<const FuelOldC5*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C6", simplefbp::C6, *dynamic_cast<const FuelOldC6*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("C7", simplefbp::C7, *dynamic_cast<const FuelOldC7*>(FuelOldLookup::Fuels[i++]));
  compare_fuel(
    "D1",
    simplefbp::D1,
  ...
  compare_fuel("S1", simplefbp::S1, *dynamic_cast<const FuelOldS1*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("S2", simplefbp::S2, *dynamic_cast<const FuelOldS2*>(FuelOldLookup::Fuels[i++]));
  compare_fuel("S3", simplefbp::S3, *dynamic_cast<const FuelOldS3*>(FuelOldLookup::Fuels[i++]));
  ...
  compare_fuel(
    "M1_05", simplefbp::M1_05, *dynamic_cast<const FuelOldM1<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_10", simplefbp::M1_10, *dynamic_cast<const FuelOldM1<10>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_15", simplefbp::M1_15, *dynamic_cast<const FuelOldM1<15>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_20", simplefbp::M1_20, *dynamic_cast<const FuelOldM1<20>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_25", simplefbp::M1_25, *dynamic_cast<const FuelOldM1<25>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_30", simplefbp::M1_30, *dynamic_cast<const FuelOldM1<30>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_35", simplefbp::M1_35, *dynamic_cast<const FuelOldM1<35>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_40", simplefbp::M1_40, *dynamic_cast<const FuelOldM1<40>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_45", simplefbp::M1_45, *dynamic_cast<const FuelOldM1<45>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_50", simplefbp::M1_50, *dynamic_cast<const FuelOldM1<50>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_55", simplefbp::M1_55, *dynamic_cast<const FuelOldM1<55>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_60", simplefbp::M1_60, *dynamic_cast<const FuelOldM1<60>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_65", simplefbp::M1_65, *dynamic_cast<const FuelOldM1<65>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_70", simplefbp::M1_70, *dynamic_cast<const FuelOldM1<70>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_75", simplefbp::M1_75, *dynamic_cast<const FuelOldM1<75>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_80", simplefbp::M1_80, *dynamic_cast<const FuelOldM1<80>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_85", simplefbp::M1_85, *dynamic_cast<const FuelOldM1<85>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_90", simplefbp::M1_90, *dynamic_cast<const FuelOldM1<90>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M1_95", simplefbp::M1_95, *dynamic_cast<const FuelOldM1<95>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_05", simplefbp::M2_05, *dynamic_cast<const FuelOldM2<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_10", simplefbp::M2_10, *dynamic_cast<const FuelOldM2<10>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_15", simplefbp::M2_15, *dynamic_cast<const FuelOldM2<15>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_20", simplefbp::M2_20, *dynamic_cast<const FuelOldM2<20>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_25", simplefbp::M2_25, *dynamic_cast<const FuelOldM2<25>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_30", simplefbp::M2_30, *dynamic_cast<const FuelOldM2<30>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_35", simplefbp::M2_35, *dynamic_cast<const FuelOldM2<35>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_40", simplefbp::M2_40, *dynamic_cast<const FuelOldM2<40>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_45", simplefbp::M2_45, *dynamic_cast<const FuelOldM2<45>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_50", simplefbp::M2_50, *dynamic_cast<const FuelOldM2<50>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_55", simplefbp::M2_55, *dynamic_cast<const FuelOldM2<55>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_60", simplefbp::M2_60, *dynamic_cast<const FuelOldM2<60>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_65", simplefbp::M2_65, *dynamic_cast<const FuelOldM2<65>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_70", simplefbp::M2_70, *dynamic_cast<const FuelOldM2<70>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_75", simplefbp::M2_75, *dynamic_cast<const FuelOldM2<75>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_80", simplefbp::M2_80, *dynamic_cast<const FuelOldM2<80>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_85", simplefbp::M2_85, *dynamic_cast<const FuelOldM2<85>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_90", simplefbp::M2_90, *dynamic_cast<const FuelOldM2<90>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_95", simplefbp::M2_95, *dynamic_cast<const FuelOldM2<95>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M1_M2_05", simplefbp::M1_M2_05, *dynamic_cast<const FuelOldM1M2<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M1_M2_10",
    simplefbp::M1_M2_10,
  ...
  compare_fuel(
    "M3_05", simplefbp::M3_05, *dynamic_cast<const FuelOldM3<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_10", simplefbp::M3_10, *dynamic_cast<const FuelOldM3<10>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_15", simplefbp::M3_15, *dynamic_cast<const FuelOldM3<15>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_20", simplefbp::M3_20, *dynamic_cast<const FuelOldM3<20>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_25", simplefbp::M3_25, *dynamic_cast<const FuelOldM3<25>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_30", simplefbp::M3_30, *dynamic_cast<const FuelOldM3<30>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_35", simplefbp::M3_35, *dynamic_cast<const FuelOldM3<35>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_40", simplefbp::M3_40, *dynamic_cast<const FuelOldM3<40>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_45", simplefbp::M3_45, *dynamic_cast<const FuelOldM3<45>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_50", simplefbp::M3_50, *dynamic_cast<const FuelOldM3<50>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_55", simplefbp::M3_55, *dynamic_cast<const FuelOldM3<55>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_60", simplefbp::M3_60, *dynamic_cast<const FuelOldM3<60>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_65", simplefbp::M3_65, *dynamic_cast<const FuelOldM3<65>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_70", simplefbp::M3_70, *dynamic_cast<const FuelOldM3<70>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_75", simplefbp::M3_75, *dynamic_cast<const FuelOldM3<75>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_80", simplefbp::M3_80, *dynamic_cast<const FuelOldM3<80>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_85", simplefbp::M3_85, *dynamic_cast<const FuelOldM3<85>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_90", simplefbp::M3_90, *dynamic_cast<const FuelOldM3<90>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_95", simplefbp::M3_95, *dynamic_cast<const FuelOldM3<95>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_100", simplefbp::M3_100, *dynamic_cast<const FuelOldM3<100>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_05", simplefbp::M4_05, *dynamic_cast<const FuelOldM4<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_10", simplefbp::M4_10, *dynamic_cast<const FuelOldM4<10>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_15", simplefbp::M4_15, *dynamic_cast<const FuelOldM4<15>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_20", simplefbp::M4_20, *dynamic_cast<const FuelOldM4<20>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_25", simplefbp::M4_25, *dynamic_cast<const FuelOldM4<25>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_30", simplefbp::M4_30, *dynamic_cast<const FuelOldM4<30>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_35", simplefbp::M4_35, *dynamic_cast<const FuelOldM4<35>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_40", simplefbp::M4_40, *dynamic_cast<const FuelOldM4<40>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_45", simplefbp::M4_45, *dynamic_cast<const FuelOldM4<45>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_50", simplefbp::M4_50, *dynamic_cast<const FuelOldM4<50>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_55", simplefbp::M4_55, *dynamic_cast<const FuelOldM4<55>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_60", simplefbp::M4_60, *dynamic_cast<const FuelOldM4<60>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_65", simplefbp::M4_65, *dynamic_cast<const FuelOldM4<65>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_70", simplefbp::M4_70, *dynamic_cast<const FuelOldM4<70>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_75", simplefbp::M4_75, *dynamic_cast<const FuelOldM4<75>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_80", simplefbp::M4_80, *dynamic_cast<const FuelOldM4<80>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_85", simplefbp::M4_85, *dynamic_cast<const FuelOldM4<85>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_90", simplefbp::M4_90, *dynamic_cast<const FuelOldM4<90>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_95", simplefbp::M4_95, *dynamic_cast<const FuelOldM4<95>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_100", simplefbp::M4_100, *dynamic_cast<const FuelOldM4<100>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M3_M4_00", simplefbp::M3_M4_00, *dynamic_cast<const FuelOldM3M4<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M3_M4_05", simplefbp::M3_M4_05, *dynamic_cast<const FuelOldM3M4<5>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M3_M4_10",
    simplefbp::M3_M4_10,
  ...
  compare_fuel(
    "M1_00", simplefbp::M1_00, *dynamic_cast<const FuelOldM1<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M2_00", simplefbp::M2_00, *dynamic_cast<const FuelOldM2<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M1_M2_00", simplefbp::M1_M2_00, *dynamic_cast<const FuelOldM1M2<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M3_00", simplefbp::M3_00, *dynamic_cast<const FuelOldM3<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel(
    "M4_00", simplefbp::M4_00, *dynamic_cast<const FuelOldM4<0>*>(FuelOldLookup::Fuels[i++])
  );
  compare_fuel_variable(
    "M3_M4_100",
    simplefbp::M3_M4_100,
