 ...
 */
[[nodiscard]] static constexpr MathSize calculate_standard_foliar_moisture_fmc(const MathSize fmc
) noexcept
{
 ...
 */
[[nodiscard]] static constexpr MathSize calculate_standard_foliar_moisture_isi(const MathSize isi
) noexcept
{
 ...
 */
[[nodiscard]] static constexpr MathSize calculate_standard_length_to_breadth(const MathSize ws
) noexcept
{
...
public:
  ...
  constexpr SimpleStandardFuel(
    ...
    : SimpleStandardFuel(code, name, can_crown, log_q, duff, duff)
  { }
