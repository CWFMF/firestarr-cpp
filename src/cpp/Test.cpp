...
)
{
  static const map<const char* const, const char* const> FMT{
    {"PREC", "%8.2f"}, {"TEMP", "%8.1f"}, {"RH", "%8g"},    {"WS", "%8.1f"},  {"WD", "%8g"},
    {"FFMC", "%8.1f"}, {"DMC", "%8.1f"},  {"DC", "%8g"},    {"ISI", "%8.1f"}, {"BUI", "%8.1f"},
    {"FWI", "%8.1f"},  {"FUEL", "%20s"},  {"CFB", "%8.3f"}, {"CFC", "%8.3f"}, {"FD", "%8c"},
    {"HFI", "%8ld"},   {"RAZ", "%8g"},    {"ROS", "%8.4g"}, {"SFC", "%8.4g"}, {"TFC", "%8.4g"},
  };
