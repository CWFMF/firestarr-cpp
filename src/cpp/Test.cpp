...
public:
  ...
  explicit TestEnvironment(
    ...
    data::ConstantGrid<topo::Cell>* cells
  ) noexcept
...
public:
  ...
  TestWeather&
  operator=(const TestWeather& rhs) = delete;
  TestWeather&
  operator=(TestWeather&& rhs) = delete;
  /**
...
)
{
  constexpr auto FMT_FBP_OUT =
    "%8.2f%8.1f%8g%8.1f%8g%8.1f%8.1f%8g%8.1f%8.1f%8.1f%8s%8.3f%8.3f%8c%8ld%8g%8.4g%8.4g%8.4g%s";
