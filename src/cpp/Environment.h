...
public:
   ...
   */
  [[nodiscard]] Cell
  offset(const Event& event, const Idx row, const Idx column) const;
...
protected:
  ...
  makeCells(const FuelGrid& fuel, const ElevationGrid& elevation);
