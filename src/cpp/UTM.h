...
void
from_lat_long(const string& proj4, const fs::topo::Point& point, MathSize* x, MathSize* y);
fs::topo::Point
to_lat_long(const string& proj4, const MathSize x, const MathSize y);
string&&
try_fix_meridian(string&& proj4);
}
#endif
