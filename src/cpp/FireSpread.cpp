    ...
    nd_(nd)
{
  ...
  if (add_offset(raz, head_ros_) && add_offsets_calc_ros(util::to_radians(10))
      ...
      && add_offsets_calc_ros(util::to_radians(140)) && add_offsets_calc_ros(util::to_radians(150))
      && add_offsets_calc_ros(util::to_radians(160)) && add_offsets_calc_ros(util::to_radians(170)))
  {
