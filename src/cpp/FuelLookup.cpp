...
public:
  ...
  FuelLookupImpl&
  operator=(const FuelLookupImpl& rhs) = delete;
  FuelLookupImpl&
  operator=(FuelLookupImpl&& rhs) = delete;
...
void
FuelLookup::listFuels() const
{
  impl_->listFuels();
}

FuelSize
FuelLookup::fuelToCode(
  const FuelType* const value
) const
{
