...
public:
  ...
  bool
  at(const HashSize h) const noexcept;
  void
  set(const HashSize h) noexcept;
  void
  clear() noexcept;
  ...
  BurnedData&
  operator=(const BurnedData& rhs) noexcept;
  BurnedData&
  operator=(BurnedData&& rhs) noexcept;
