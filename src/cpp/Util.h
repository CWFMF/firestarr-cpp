 ...
 */
void
read_directory(const bool for_files, const string& name, vector<string>* v, const string& match);
/**
 ...
 */
void
read_directory(const string& name, vector<string>* v, const string& match);
/**
 * \brief Get a list of items in the given directory matching the given regex
 * \param for_files Match files and not directories
 * \param name Directory to search
 ...
 */
void
read_directory(const bool for_files, const string& name, vector<string>* v);
/**
 ...
 */
void
read_directory(const string& name, vector<string>* v);
/**
...
find_rasters(const string& dir, int year);
/**
 ...
 */
tm
to_tm(const int year, const int month, const int day, const int hour, const int minute);
/**
 ...
 */
void
month_and_day(const int year, const size_t day_of_year, size_t* month, size_t* day_of_month);
/**
