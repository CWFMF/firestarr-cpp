...
public:
  ...
  Direction&
  operator=(const Direction& rhs) noexcept = default;
  Direction&
  operator=(Direction&& rhs) noexcept = default;
...
public:
  ...
  Wind(
    ...
    : wsv_x_(speed.asValue() * sin(direction.heading())),
      wsv_y_(speed.asValue() * cos(direction.heading())),
  ...
  Wind&
  operator=(const Wind& rhs) noexcept = default;
  Wind&
  operator=(Wind&& rhs) noexcept = default;

  /**
   * \brief Speed of wind (km/h)
   * \return Speed of wind (km/h)
   */
  [[nodiscard]] constexpr const Speed&
   ...
   */
  [[nodiscard]] constexpr const Direction&
...
public:
  ...
  Weather&
  operator=(Weather&& rhs) noexcept = default;
  Weather&
   ...
   */
  [[nodiscard]] constexpr const RelativeHumidity&
  rh() const noexcept
  {
    return rh_;
  }
   ...
   * \return Wind (km/h)
   */
  [[nodiscard]] constexpr const Wind&
  wind() const noexcept
  {
    return wind_;
  }
