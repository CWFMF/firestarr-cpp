...
public:
  ...
  IObserver&
  operator=(const IObserver& rhs) = delete;
  IObserver&
  operator=(IObserver&& rhs) = delete;
  /**
   ...
   */
  virtual void
  handleEvent(const Event& event) = 0;
  /**
   ...
   */
  virtual FileList
  save(const string_view dir, const string_view base_name) const = 0;
  /**
   ...
   */
  static string
  makeName(const string_view base_name, const string_view suffix);
...
public:
  ...
  MapObserver&
  operator=(const MapObserver& rhs) = delete;
  MapObserver&
  operator=(MapObserver&& rhs) = delete;
   ...
   */
  [[nodiscard]] virtual T
  getValue(const Event& event) const = 0;
...
public:
  ...
  ArrivalObserver&
  operator=(const ArrivalObserver& rhs) = delete;
  ArrivalObserver&
  operator=(ArrivalObserver&& rhs) = delete;
  /**
   * \brief Constructor
