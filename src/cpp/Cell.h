...
public:
   ...
   * \return Hash
   */
  [[nodiscard]] static constexpr Topo
  hashCell(
   ...
   */
  [[nodiscard]] constexpr SpreadKey
  key() const noexcept
  {
    // should be able to fit this in a uint32_t
...
protected:
   ...
   */
  static constexpr uint32_t FuelShift = LocationBits + 10;
  /**
   * \brief Number of bits in fuel bitmask
   */
  static constexpr uint32_t FuelBits = 6;
  /**
   ...
   */
  static constexpr uint32_t AspectBits = 9;
  /**
   ...
   */
  static constexpr uint32_t SlopeBits = 7;
  /**
