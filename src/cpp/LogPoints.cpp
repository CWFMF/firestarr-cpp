...
std::function<void(size_t, const char, const DurationSize, const XYSize, const XYSize)>
  fct_log_point = &no_log_point;
std::function<void(size_t, const char, const DurationSize, const CellPoints&)>
  fct_log_points = &no_log_points;
