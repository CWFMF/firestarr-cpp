 ...
 */
class ConstantWeather final : public wx::FireWeather
{
public:
  ...
  ConstantWeather&
  operator=(const ConstantWeather& rhs) = delete;
  ConstantWeather&
  operator=(ConstantWeather&& rhs) = delete;
  /**
  ...
  ConstantWeather(
    ...
    : ConstantWeather(set<const fuel::FuelType*>{fuel}, start_date, dc, dmc, ffmc, wind)
  {
  }
  ConstantWeather(
