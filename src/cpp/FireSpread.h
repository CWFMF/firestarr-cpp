...
int
calculate_nd_ref_for_point(const int elevation, const Point& point) noexcept;
int
calculate_nd_for_point(const Day day, const int elevation, const Point& point);
