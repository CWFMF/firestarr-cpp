...
int
calculate_nd_ref_for_point(const int elevation, const topo::Point& point) noexcept;
int
calculate_nd_for_point(const Day day, const int elevation, const topo::Point& point);
/**
...
public:
   ...
   */
  [[nodiscard]] constexpr const wx::Wind&
  wind() const
  {
    return weather()->wind();
  }
   ...
   */
  [[nodiscard]] constexpr const wx::Ffmc&
  ffmc() const
  {
    return weather()->ffmc();
  }
   ...
   */
  [[nodiscard]] constexpr const wx::Bui&
  bui() const
  {
    return weather()->bui();
  }
   ...
   */
  [[nodiscard]] constexpr const wx::Dmc&
  dmc() const
  {
    return weather()->dmc();
  }
   ...
   */
  [[nodiscard]] constexpr const wx::Dc&
  dc() const
  {
    return weather()->dc();
  }
