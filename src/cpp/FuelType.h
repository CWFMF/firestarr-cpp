...
public:
   ...
   */
  [[nodiscard]] static constexpr FuelCodeSize
  safeCode(
    const FuelType* fuel
  )
  {
  ...
  FuelType&
  operator=(FuelType&& rhs) noexcept = delete;
  FuelType&
  operator=(const FuelType& rhs) noexcept = delete;
  ...
  survivalProbability(const FwiWeather& wx) const noexcept = 0;
  /**
   ...
   */
  [[nodiscard]] virtual MathSize
  calculateRos(int nd, const FwiWeather& wx, MathSize isi) const = 0;
  /**
   ...
   */
  [[nodiscard]] constexpr FuelCodeSize
  code() const
  {
    return code_;
  }
...
public:
  ...
  FuelBase&
  operator=(FuelBase&& rhs) noexcept = delete;
  FuelBase&
  operator=(const FuelBase& rhs) = delete;
   ...
   */
  [[nodiscard]] constexpr const Duff*
  duffDmcType() const
  {
    return duff_dmc_;
  }
...
public:
  ...
  InvalidFuel&
  operator=(const InvalidFuel& rhs) noexcept = delete;
  InvalidFuel&
  operator=(InvalidFuel&& rhs) noexcept = delete;
   ...
   */
  [[nodiscard]] MathSize
  grass_curing(const int nd, const FwiWeather& wx) const override;
  /**
   * \brief Throw a runtime_error
   * \return Throw a runtime_error
   */
   ...
   */
  [[nodiscard]] MathSize
  calculateRos(int, const FwiWeather&, MathSize) const override;
  /**
   * \brief Throw a runtime_error
   * \return Throw a runtime_error
   */
   ...
   */
  [[nodiscard]] ThresholdSize
  survivalProbability(const FwiWeather&) const noexcept override;
};
}
#endif
