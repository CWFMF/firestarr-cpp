...
public:
  ...
  operator=(const SettingsImplementation& rhs) = delete;
  SettingsImplementation&
  operator=(SettingsImplementation&& rhs) = delete;
  static SettingsImplementation&
  instance() noexcept;
  /**
   ...
   */
  [[nodiscard]] const char*
  fuelLookupTable() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr double
  minimumFfmcAtNight() const noexcept
  {
  ...
  defaultPercentConifer() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr int
  defaultPercentDeadFir() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr int
  intensityMaxLow() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr int
  intensityMaxModerate() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr size_t
  simulationRecheckInterval() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr size_t
  concurrentSimulationRounds() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr size_t
  minimumSimulationRounds() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr double
  confidenceLevel() const noexcept
  {
   ...
   */
  [[nodiscard]] constexpr double
  thresholdScenarioWeight() const noexcept
  {
 ...
 */
SettingsImplementation&
SettingsImplementation::instance() noexcept
{
...
) noexcept
{
  try
  {
    ...
    output_date_offsets_ = parse_list<int>(
      get_value(settings, "OUTPUT_DATE_OFFSETS"),
      [](const string& s) {
        return stoi(s);
      }
    );
    ...
    simulation_recheck_interval_ = static_cast<size_t>(
      stoi(get_value(settings, "SIMULATION_RECHECK_INTERVAL"))
    );
    concurrent_simulation_rounds_ = static_cast<size_t>(
      stoi(get_value(settings, "CONCURRENT_SIMULATION_ROUNDS"))
    );
...
const char*
Settings::outputDirectory() noexcept
{
...
const char*
Settings::rasterRoot() noexcept
{
  return SettingsImplementation::instance().rasterRoot();
}
const char*
Settings::fuelLookupTable() noexcept
{
...
double
Settings::maximumSpreadDistance() noexcept
{
  return SettingsImplementation::instance().maximumSpreadDistance();
}
double
Settings::minimumFfmc() noexcept
{
...
size_t
Settings::simulationRecheckInterval() noexcept
{
  return SettingsImplementation::instance().simulationRecheckInterval();
}
size_t
Settings::concurrentSimulationRounds() noexcept
{
