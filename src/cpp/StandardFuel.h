 ...
 * \return Length to Breadth ratio [ST-X-3 eq 79]
 */
static const util::LookupTable<&calculate_standard_length_to_breadth> STANDARD_LENGTH_TO_BREADTH{};
/**
...
public:
  ...
  StandardFuel&
  operator=(StandardFuel&& rhs) noexcept = delete;
  StandardFuel&
  operator=(const StandardFuel& rhs) = delete;
  /**
