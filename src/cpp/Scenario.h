...
public:
   ...
   */
  [[nodiscard]] Scenario*
  reset_with_new_start(const HashSize start_cell, util::SafeVector* final_sizes);
  /**
   ...
   */
  Scenario*
  run(vector<shared_ptr<ProbabilityMap>>* probabilities);
  /**
...
public:
   ...
   */
  vector<shared_ptr<ProbabilityMap>>* probabilities_;
  /**
