...
public:
   ...
   */
  static int
  openLogFile(const char* filename) noexcept;
  /**
   * \brief Set output log file
 ...
 */
void
extensive(const char* format, ...) noexcept;
/**
 ...
 */
void
verbose(const char* format, ...) noexcept;
/**
 ...
 */
void
debug(const char* format, ...) noexcept;
/**
 ...
 */
void
note(const char* format, ...) noexcept;
/**
 ...
 */
void
check_fatal(bool condition, const char* format, ...)
#ifdef NDEBUG
  noexcept
#endif
  ;
 ...
 */
void
check_equal(const MathSize lhs, const MathSize rhs, const char* name)
#ifdef NDEBUG
  noexcept
#endif
  ;
 ...
 */
void
check_equal(const char* lhs, const char* rhs, const char* name)
#ifdef NDEBUG
  noexcept
#endif
  ;
...
#endif
{
  logging::check_fatal(lhs != rhs, "Expected %s to be %d but got %d", name, rhs, lhs);
}
/**
...
protected:
  virtual string
  add_log(const char* format) const noexcept = 0;
  void
  log_output(const int level, const char* format, ...) const noexcept;
  void
  log_extensive(const char* format, ...) const noexcept;
  void
  log_verbose(const char* format, ...) const noexcept;
  void
  log_debug(const char* format, ...) const noexcept;
  void
  log_info(const char* format, ...) const noexcept;
  void
  log_note(const char* format, ...) const noexcept;
  void
  log_warning(const char* format, ...) const noexcept;
  void
  log_error(const char* format, ...) const noexcept;
  void
  log_check_fatal(bool condition, const char* format, ...) const
#ifdef NDEBUG
    noexcept
#endif
    ;
  void
  log_fatal(const char* format, ...) const
#ifdef NDEBUG
    noexcept
#endif
    ;
