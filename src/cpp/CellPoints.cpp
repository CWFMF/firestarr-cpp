...
bool CellPoints::is_invalid() const
{
  ...
  logging::check_equal(
    cell_x_ == INVALID_XY_LOCATION, cell_y_ == INVALID_XY_LOCATION, "CellPoints Idx is invalid"
  );
...
#endif
  logging::check_fatal(
    cell_x_ == INVALID_XY_LOCATION, "CellPoints should always be initialized with some Location"
  );
