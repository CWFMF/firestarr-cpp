...
public:
  ...
  Duff&
  operator=(const Duff& rhs) noexcept = delete;
  Duff&
  operator=(Duff&& rhs) noexcept = delete;
  ...
  probabilityOfSurvival(MathSize mc_pct) const noexcept = 0;
  //  /**
...
public:
  ...
  DuffType&
  operator=(const DuffType& rhs) noexcept = delete;
  DuffType&
  operator=(DuffType&& rhs) noexcept = delete;
