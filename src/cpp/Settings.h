...
public:
   ...
   */
  static void
  setSaveIndividual(bool value) noexcept;
  /**
   ...
   */
  static void
  setRunAsync(bool value) noexcept;
  /**
   ...
   */
  static void
  setDeterministic(bool value) noexcept;
  /**
   ...
   */
  static void
  setSaveAsAscii(bool value) noexcept;
  /**
   ...
   */
  static void
  setSaveSimulationArea(bool value) noexcept;
  /**
   ...
   */
  static void
  setRowColIgnition(bool value) noexcept;
  /**
   ...
   */
  static void
  setIgnRow(const int value) noexcept;
  /**
   ...
   */
  static void
  setIgnCol(const int value) noexcept;
  /**
   * \brief Static curing value
   * \return Static curing value
   */
  [[nodiscard]] static int
  staticCuring() noexcept;
  /**
