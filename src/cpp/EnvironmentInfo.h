...
public:
   ...
   */
  [[nodiscard]] static unique_ptr<EnvironmentInfo>
  loadInfo(const string_view in_fuel, const string_view in_elevation);
  ~EnvironmentInfo();
  /**
  ...
  EnvironmentInfo&
  operator=(EnvironmentInfo&& rhs) noexcept = default;
  EnvironmentInfo&
  operator=(const EnvironmentInfo& rhs) = delete;
  /**
