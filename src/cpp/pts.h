...
static constexpr const DistanceSize INVALID_DISTANCE = static_cast<DistanceSize>(MAX_ROWS * MAX_ROWS);
...
template <class T>
constexpr std::array<T, NUM_DIRECTIONS> make_filled(const T& value)
{
