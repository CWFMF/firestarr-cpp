...
DIR_IN="${DIR_TEST}/input/10N_50651"
DIR_OUT="${DIR_TEST}/output/slow"
...
# sed -i "s/MINIMUM_FFMC = .*/MINIMUM_FFMC = 70.0/g" settings.ini
sed -i "s/MINIMUM_FFMC_AT_NIGHT = .*/MINIMUM_FFMC_AT_NIGHT = 100.0/g" settings.ini
sed -i "s/OFFSET_SUNRISE = .*/OFFSET_SUNRISE = 0.0/g" settings.ini
sed -i "s/OFFSET_SUNSET = .*/OFFSET_SUNSET = 9.0/g" settings.ini
