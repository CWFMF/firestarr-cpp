...
rm -rf ${DIR_BUILD}
cmake --no-warn-unused-cli ${OPTS} -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_BUILD_TYPE:STRING=RelWithDebInfo -S${DIR_ROOT} -B${DIR_BUILD} -G "Unix Makefiles" > /dev/null 2>&1
