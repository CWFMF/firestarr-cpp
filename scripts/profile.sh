...
rm -rf ${DIR_BUILD}
/usr/local/bin/cmake --no-warn-unused-cli -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_BUILD_TYPE:STRING=RelWithDebInfo -S${DIR_ROOT} -B${DIR_BUILD} -G "Unix Makefiles"
